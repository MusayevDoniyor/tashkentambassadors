  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] py-20 px-4 text-center">
      <div className="relative mb-8">
        <div className="text-9xl md:text-[14rem] font-black text-orange-600/10 select-none">
          404
        </div>
      ...
      <div>
        <Link
          to="/"
          className="inline-flex items-center space-x-2 bg-orange-600 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-sm hover:bg-orange-700 transition-all shadow-xl shadow-orange-200 active:scale-95 group"
        >
          <ArrowLeft size={18} />
