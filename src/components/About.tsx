...
import { Lightbulb, Presentation, PieChart, Users, CheckCircle, Sparkles, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-32">
        <div className="relative order-2 lg:order-1 px-4 lg:px-0">
          ...
          <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-white group">
            <img 
              ...
              alt="Startup Meeting" 
              className="w-full h-[300px] sm:h-[400px] lg:h-[550px] object-cover group-hover:scale-105 transition-transform duration-1000"
            />
            ...
            <div className="absolute bottom-10 left-10 right-10">
              <div className="bg-white/10 backdrop-blur-md p-6 rounded-3xl border border-white/20 text-white">
                <p className="font-black italic text-lg leading-tight">"Start up haqida bilmasangiz biz sizga buni o'rgatamiz!" ✨</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="text-lg text-gray-600 mb-10 leading-relaxed font-medium">
            Bizning klub asoschilari ya'ni Ambassadorlar <strong>Yoshlar ishlari agentligi</strong> va <strong>Yoshlar Ventures</strong> tomonidan saralab olingan. Toshkent shahridagi eng istiqbolli g'oyalarni haqiqiy biznesga aylantiramiz ✅
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="flex items-center space-x-3 bg-white p-5 rounded-[2rem] border border-orange-50 shadow-sm hover:border-orange-200 transition-colors">
                <div className="bg-orange-600 rounded-full p-1">
                  <CheckCircle className="text-white w-4 h-4" />
                </div>
                <span className="text-gray-900 font-black text-xs uppercase tracking-tight">{item}</span>
              </div>
            ))}
          </div>
      ...
      <div className="text-center mb-20">
        <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-6 uppercase tracking-tighter italic">NIMALARNI <span className="text-orange-600">O'RGATAMIZ?</span></h3>
        <p className="text-gray-500 font-medium max-w-xl mx-auto">Startup ekotizimida o'sish uchun kerak bo'lgan asosiy bilim va tajribalarni taqdim etamiz</p>
      </div>

      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
        {TRAINING_PROGRAMS.map((program) => (
          <div key={program.id} className="p-10 bg-white border border-orange-50 rounded-[3rem] hover:border-orange-500 hover:shadow-2xl hover:shadow-orange-100 transition-all group relative overflow-hidden flex flex-col">
            ...
            <h4 className="text-2xl font-black text-gray-900 mb-4 tracking-tight leading-none uppercase">{program.title}</h4>
            <p className="text-gray-500 text-sm leading-relaxed font-medium mb-6">{program.description}</p>
