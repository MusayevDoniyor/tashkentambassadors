        ...
        {filteredEvents.length > 0 ? (
          filteredEvents.map((event) => {
            ...
            return (
              <div
                key={event.id}
                className="group bg-white rounded-[2.5rem] border border-orange-50 overflow-hidden hover:shadow-2xl transition-all duration-300 flex flex-col md:flex-row hover:-translate-y-1"
              >
