  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <motion.div
        ...
        className="mb-16 flex flex-col md:flex-row gap-4 items-center justify-center px-4"
      >
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          animate="visible"
          exit="hidden"
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 justify-center"
        >
      ...
      {filteredAmbassadors.length === 0 && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="text-center py-20 bg-orange-50/30 rounded-[2.5rem] border-2 border-dashed border-orange-100"
        >
